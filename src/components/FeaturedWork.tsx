    ...
    <div className="w-[100vw] h-full flex items-center justify-center p-8 md:px-24">
      <div className="w-full max-w-7xl h-full flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 group">
        ...
        <div className="w-full md:w-1/2 h-full flex items-center justify-center md:justify-end">
          <Link href={`/work/${category.slug}`} className="relative w-full max-w-md aspect-[3/4] rounded-2xl overflow-hidden glass-dark group-hover:-translate-y-4 transition-transform duration-700 ease-out cursor-pointer group/img">
            <motion.div 
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
              <div className="w-20 h-20 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white tracking-widest text-xs uppercase opacity-0 scale-50 group-hover/img:opacity-100 group-hover/img:scale-100 transition-all duration-500 ease-out">
                View
              </div>
            </div>
